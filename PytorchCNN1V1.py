    ...
    if((n_epoch%1)==0): # change the denominator
        ...
        for c, (input_test,targets) in enumerate (test_loader):
            with torch.no_grad():
                ...
                size_label=len(targets)
                
                # print(" ----- ")
                # print(" print(torch.max(output.data, 1))  ", torch.max(output.data, 1))
                # print(" ----- ")
                # print(" print(type(torch.max(output.data, 1)))  ", type(torch.max(output.data, 1)))
                # #---------------------------------------------------------------------
                # print(" #---------------------------------------------------------------------")
                # print(" print(torch.max(output.data, 1))  ", torch.max(output.data))
                # print(" ----- ")
                # print(" print(type(torch.max(output.data, 1)))  ", type(torch.max(output.data)))
                #---------------------------------------------------------------------
                print(" #---------------------------------------------------------------------")
                d=torch.max(output.data,1)
                print("d=",d)
                print("type(d)",type(d))
                #---------------------------------------------------------------------
                print(" #---------------------------------------------------------------------")
                ...
                # output=myModel(input_test)
                # predict=torch.max(output.data,1)
                # torch.max()
