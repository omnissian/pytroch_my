...
#--------------------------------------------------------------
images_in_batch,labels_in_batch=iter(train_loader).next() # ++++++++++++++++++++++
print("tensor of batch images size = ", images_in_batch.size()) # torch.Size([3000, 1, 28, 28])
image_plt =images_in_batch[0] # ++++++++++++++++++++++
label_type=labels_in_batch[0] # ++++++++++++++++++++++
print("tensor of batch images size = ", image_plt.size())#torch.Size([1, 28, 28])
fig=plt.figure(0) # ++++++++++++++++++++++
number=str(labels_in_batch[0].item()) # ++++++++++++++++++++++
fig.canvas.set_window_title(number) # ++++++++++++++++++++++
fig=plt.imshow(image_plt.numpy()[0],cmap='gray') # ++++++++++++++++++++++
...
#-----------debug img----------------
print("type(image_plt) = ",type(image_plt))# type(image_plt) =  <class 'torch.Tensor'>
print("---->image_plt.size() = ",image_plt.size()) #  torch.Size([1, 28, 28])
# print("image_plt = ",image_plt)

print("type(image_plt.numpy()) = ",type(image_plt.numpy())) #  <class 'numpy.ndarray'>
# print("image_plt.numpy() = ",image_plt.numpy())

print("------->type(image_plt.numpy()[0]) = ",type(image_plt.numpy()[0])) # <class 'numpy.ndarray'>)
# print("------->type(image_plt.numpy()[0].size()) = ",type(image_plt.numpy()[0].size()))
# print("image_plt.numpy()[0] = ",image_plt.numpy()[0])
